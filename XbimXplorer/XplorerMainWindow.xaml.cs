...
namespace XbimXplorer
{
	...
	public partial class XplorerMainWindow : IXbimXplorerPluginMasterWindow, INotifyPropertyChanged
	{
		...
		private void XplorerMainWindow_Closing(object sender, CancelEventArgs e)
		{
		...
		private void XplorerMainWindow_Loaded(object sender, RoutedEventArgs e)
		{
		...
		private void CreateLodStyles()
		{
			if (LodStyles == null)
			{
				...
				{
					if (lod != LODs.Default)
						LodStyles.Add(lod, new SurfaceLayerStyler(lod, this.Logger));
					else
